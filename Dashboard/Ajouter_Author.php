    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Formulaire d'ajoute Authors</h1>
        </div>
                ...
                <div class="form-row align-items-center">
                      ...
                      <div class="col-auto">
                        ...
                        <div class="input-group mb-2">
                          <input type="name" name="fullname" class="form-control" id="inlineFormInputGroup" placeholder="Full name">
                        </div>
                      </div>
                      ...
                      <div class="col-auto">
                        ...
                        <div class="input-group mb-2">
                          <input type="Email" name="Email" class="form-control" id="inlineFormInputGroup" placeholder="Email Adresse">
                        </div>
                      </div>
...
{ 
  ...
  $sql = "INSERT INTO authors (nom,email,img)
  VALUES ('$Fname','$Email','$filepath')";
