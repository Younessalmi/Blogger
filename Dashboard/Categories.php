    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div style="margin:20px 10px;">
          <a href="./Ajouter_categorie.php"><button type="button" class="btn btn-primary">Ajouter une nouvelle Categories</button></a>
        </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
              ...
              <?php foreach ( $categoriesSELECTED as $categorieSELECTED ) {?>

              <tr>
                <td><?= $categorieSELECTED->id?></td>
                <td><?= $categorieSELECTED->nom?></td>
                <th><img style="width:100px;" src="<?=$categorieSELECTED->img?>" alt=""></th>
                <th class="col-1"><a href="./Edite_Category.php?id=<?=$categorieSELECTED->id?>" class="btn btn-primary">EDIT</a></th>
                <th class="col-1"> <a href="./Delete_Category.php?id=<?=$categorieSELECTED->id?>" class="btn btn-danger">Delete</a> </th>
              </tr> 
