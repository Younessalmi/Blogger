...
$articlesSELECTED = $SelectAll->fetchAll(PDO::FETCH_OBJ);
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div style="margin:20px 10px;">
         <a href="./Ajouter_Article.php"> <button type="button" class="btn btn-primary">Ajouter un nouvelle Article</button></a>
        </div>
        ...
        <table class="table table-striped table-sm">
            ...
            <?php foreach($articlesSELECTED as $articleSELECTED) { ?>
              <tr>
                <td><?= $articleSELECTED->id?></td>
                <td><?= $articleSELECTED->categ_id?></td>
                <td><?= $articleSELECTED->author_id?></td>
                <td><?= $articleSELECTED->title?></td>
                <th class="col-2"><img width="200px" src=<?= $articleSELECTED-> img?>></th>
                <th class="col-1"><a href="./Edite_Article.php?id=<?=$articleSELECTED->id?>" class="btn btn-primary">EDIT</a> </th>
                <th class="col-1"> <a href="./Delete_Article.php?id=<?=$articleSELECTED->id?>" class="btn btn-danger">Delete</a> </th>
              </tr>                                                 
            <?php } ?> 
