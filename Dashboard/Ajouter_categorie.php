    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2 ">Formulaire d'ajoute Categories</h1>
        </div>
              ...
              <form method="POST" action="#" enctype="multipart/form-data">
                    <div class="form-row align-items-center">
                      ...
                      <div class="col-auto">
                        ...
                        <input type="text" name="Cname" class="form-control mb-2" id="inlineFormInput" placeholder="Ajouter categories">
                      </div>

                      <div class="col-auto">
                        <label class="sr-only" for="inlineFormInputGroup">Category Image</label>
                        <div class="input-group mb-2">
                          <input type="file" name="Cimage" class="form-control" id="inlineFormInputGroup" placeholder="Username">
                        </div>
                      </div>
...
{ 
  ...
  $sql = "INSERT INTO categories (nom,img)
  VALUES ('$Cname','$filepath')";
